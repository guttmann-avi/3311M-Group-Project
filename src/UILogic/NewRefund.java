...
public class NewRefund implements Output {

    private Household household;
    private HashMap<String, String> inputValues;
    private String[] inputs;

    public NewRefund(HashMap<String, String> inputValues, String[] inputs, Household household) {
    ...
    public String output() {
        return "Return has been added successfully to " + inputValues.get(inputs[4]) + ".";
    }

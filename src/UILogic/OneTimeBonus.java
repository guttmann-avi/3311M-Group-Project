...
public class OneTimeBonus implements Output {
    
    private HashMap<String, String> inputValues;
    private String[] inputs;

    public OneTimeBonus(HashMap<String, String> inputValues, String[] inputs) {
    ...
    public Household setHousehold(Household household) {
        if (success()) {
            Income income = new Income(Double.parseDouble(inputValues.get(inputs[1])), inputValues.get(inputs[4]), "One Time Bonus");

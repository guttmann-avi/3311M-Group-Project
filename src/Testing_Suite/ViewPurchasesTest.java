...
public class ViewPurchasesTest {
	...
	public void testViewPurchasesOutput1() {
		...
		assertEquals(
				"User Name: Avi0001\nUser Avi0001 Income is 0.00 \tMoney Left: -200.00\nPurchase Id: "+purchase1.getPurchaseId()+"\t Purchase Amount: 100.00\t Purchase Date: 02/02/2022\t Category: Other\nPurchase Id: "+purchase2.getPurchaseId()+"\t Purchase Amount: 200.00\t Purchase Date: 02/02/2022\t Category: Other\nPurchase Id: "+purchase3.getPurchaseId()+"\t Purchase Amount: -100.00\t Purchase Date: 10/02/2022\t Category: Other\n",
	...
	public void testViewPurchasesOutput2() {
		...
		Purchases purchase1 = new Purchases(400, new Date(2022-1900, 02-1, 02));
		Purchases purchase2 = new Purchases(600, new Date(2022-1900, 02-1, 02));
		Purchases purchase3 = new Purchases(-1000, new Date(2022-1900, 02-1, 10));
		user.addPurchases(purchase1);
		user.addPurchases(purchase2);
		user.addPurchases(purchase3);
		assertEquals(
				"User Name: Mark0002\nUser Mark0002 Income is 5000.00 \tMoney Left: 5000.00\nPurchase Id: "+purchase1.getPurchaseId()+"\t Purchase Amount: 400.00\t Purchase Date: 02/02/2022\t Category: Other\nPurchase Id: "+purchase2.getPurchaseId()+"\t Purchase Amount: 600.00\t Purchase Date: 02/02/2022\t Category: Other\nPurchase Id: "+purchase3.getPurchaseId()+"\t Purchase Amount: -1000.00\t Purchase Date: 10/02/2022\t Category: Other\n",
				new ViewPurchases(user, true, null,null).output());
	}
	...
	public void testViewPurchasesOutput3() {
		...
		user.addPurchases(purchase3);
		assertEquals(
				"User Name: John0007\nUser John0007 Income is 0.00 \tMoney Left: -11300.00\nPurchase Id: "+purchase1.getPurchaseId()+"\t Purchase Amount: 10000.00\t Purchase Date: 02/02/2022\t Category: Other\nPurchase Id: "+purchase2.getPurchaseId()+"\t Purchase Amount: 2500.00\t Purchase Date: 02/02/2022\t Category: Other\nPurchase Id: "+purchase3.getPurchaseId()+"\t Purchase Amount: -1200.00\t Purchase Date: 10/02/2022\t Category: Other\n",
				new ViewPurchases(user, true, null,null).output());
	}
